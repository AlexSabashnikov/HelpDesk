    ...
    >   
      <template #cell-organization="{ row }">
        <div class="organization-cell" :title="row.name">
          ...
          <div v-if="row.type_agent" class="org-short-name">
            {{ getAgentLabel(row.type_agent) }}
          </div>
        </div>
      </template>
      ...
      <template #cell-adress="{ row }">
        <div class="address-cell" :title="getMainOfficeAddress(row)">
          {{ truncateText(getMainOfficeAddress(row), 40) }}
        </div>
      </template>

      <template #cell-main_contact="{ row }">
        <div class="main-contact-cell" v-if="getMainContact(row)">
