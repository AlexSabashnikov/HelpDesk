  ...
  <div class="all-organizations-page">
    ...
    <div class="table-controls">
      ...
      <div class="quick-filters">
        <UIButton
        class="filter-btn"
        :class="{ 'filter-btn--customer--active': selectedTypes.includes(1) }"
        @click="setQuickFilter(1)"
      >
        Заказчики
      </UIButton>
      ...
      <UIButton
        class="filter-btn"
        :class="{ 'filter-btn--contractor--active': selectedTypes.includes(2) }"
        @click="setQuickFilter(2)"
      >
        Подрядчики
      </UIButton>
      ...
      <UIButton
        class="filter-btn"
        :class="{ 'filter-btn--subcontractor--active': selectedTypes.includes(3) }"
        @click="setQuickFilter(3)"
      >
        Субподрядчики
      </UIButton>
      ...
      <UIButton
        class="filter-btn"
        :class="{ 'filter-btn--ourCompany--active': selectedTypes.includes(4) }"
        @click="setQuickFilter(4)"
      >
...
const selectedTypes = ref([]) // хранит числа 1,2,3
...
// После сохранения - инвалидируем кэш
...
// Инициализация
onMounted(() => {
  console.log('DCompanies mounted, загружаем организации...')
  loadOrganizations()
})
</script>
...
.filter-btn--ourCompany--active:hover {
